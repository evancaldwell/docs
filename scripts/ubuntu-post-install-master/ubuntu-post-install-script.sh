...
echo '10. Install NPM tools?'
echo '11. Customize system??'
echo '12. Cleanup the system?'
echo 'q. Quit?'
echo ''
echo 'Remember to enable connonical partners, additional drivers and double click.'
echo ' --see http://itsfoss.com/things-todo-elementary-os-freya, http://linuxscoop.com/video/20-things-to-do-after-installing-elementary-os-freya'
echo
...
case $REPLY in
    ...
    10) clear && npm;; #Install NPM Tools
